// ============================================================
// LUCIDE REGISTRY — 50+ icônes essentielles + icônes systèmes
...
export const LUCIDE_ICON_LIST: LucideIconItem[] = [
  ...
  { id: 'FileEdit', label: 'Éditer fichier', category: 'Actions', keywords: ['modifier', 'document'] },
  // Statut
...
// ✅ Résolution d'icône — export nommé explicite
