...
export const NAVBAR_REGISTRY: Record<NavbarStyle, NavbarDefinition> = {
  // ⭐ Classique — utilise navbarBg
  classic: {
    id: "classic",
    nom: "Classique",
    description: "Style classique avec fond configurable",
    containerStyle: {
  ...
  // ⭐ Sombre — garde son fond sombre spécifique
  dark: {
    id: "dark",
    nom: "Sombre",
  ...
  // ⭐ Flottant — utilise navbarBg + glassmorphism
  floating: {
    id: "floating",
    nom: "Flottant",
    description: "Style flottant avec effet glassmorphism",
    containerStyle: {
      backgroundColor: 'var(--color-navbarBg, rgba(255,255,255,0.92))',
  ...
  // ⭐ Dégradé — garde son dégradé spécifique
  gradient: {
    id: "gradient",
    nom: "Dégradé",
  ...
  // ⭐ Verre — utilise navbarBg + transparence
  glass: {
    id: "glass",
    nom: "Verre",
    description: "Style transparent avec effet verre",
    containerStyle: {
      backgroundColor: 'var(--color-navbarBg, rgba(255,255,255,0.1))',
