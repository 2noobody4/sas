...
import { MAIN_MODULES as _MAIN_MODULES } from './modules/mainModules';
import { OTHER_MODULES as _OTHER_MODULES } from './modules/otherModules';
import { MANAGEMENT_MODULES as _MANAGEMENT_MODULES } from './modules/management/index';
// ❌ SUPPRIMÉ : import { CLIENT_MODULES as _CLIENT_MODULES } from './modules/clientModules';

// ============================================================
// HELPERS
// ============================================================

import { ModuleDefinition, NavItem } from './modules/types';

// Registre complet (sans CLIENT_MODULES)
