...
export const Modal: React.FC<ModalProps> = ({
  ...
  // ✅ Construction des classes avec max-height dynamique
  const modalClasses = `w-full ${maxWidthClasses[maxWidth]} bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden mt-[64px] ${className}`;

  // ✅ Style via proprietes pour MotionBox
  const modalStyle = {
    proprietes: {
      maxHeight: maxHeight,
