...
interface AnnouncementBannerProps {
  ...
  /** Si true, le composant est poussé hors du viewport (invisible mais monté) */
  forceHidden?: boolean;
}
...
export const AnnouncementBanner: React.FC<AnnouncementBannerProps> = ({
  ...
  // Si forceHidden → on pousse hors viewport mais on garde le composant monté
  const hiddenStyles: React.CSSProperties = forceHidden
    ? {
        position: 'fixed',
        top: 0,
        left: 0,
