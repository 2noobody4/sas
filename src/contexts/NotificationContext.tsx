...
import { ToastItem } from '../components/ui/NotificationToast';
import { Announcement } from '../components/ui/AnnouncementBanner';
...
let welcomeAnnouncementAdded = false;
...
export const NotificationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (!welcomeAnnouncementAdded) {
      welcomeAnnouncementAdded = true;
      const demoAnnouncement: Omit<Announcement, 'id'> = {
        type: 'update',
        title: '🚀 Bienvenue sur App PME V3',
        description: 'Découvrez les nouvelles fonctionnalités : export PDF/Excel, mode hors ligne amélioré et notifications en temps réel.',
        actionLabel: 'Explorer',
        actionUrl: '/gestion',
        dismissible: true,
      };
      announcementStore.addAnnouncement(demoAnnouncement);
    }
