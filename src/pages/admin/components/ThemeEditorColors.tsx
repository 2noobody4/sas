        ...
        <div key={category} className="mb-4 last:mb-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {keys.map((key) => {
              ...
              return (
                <div key={key} className="flex items-center gap-3 p-2 rounded-lg border border-[var(--color-borderColor)] bg-[var(--color-cardBg)]">
                  <label className="text-sm capitalize w-24 flex-shrink-0 text-[var(--color-textPrimary)]">
                    {labelFr}
                  </label>
                  <input
                    type="color"
