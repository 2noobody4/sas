...
import { ProductDetailModal } from '../../components/stocks/ProductDetailModal';
import { ReapprovisionnementModal } from '../../components/stocks/ReapprovisionnementModal';
import { ProductFormModal } from '../../components/stocks/ProductFormModal';
...
export const StocksPage: React.FC = () => {
  ...
  const handleFacturer = (produit: Produit) => {
    history.push(`/gestion/comptabilite/factures/nouvelle/emise?produit_id=${produit.id}`);
  };
    if (window.confirm(
