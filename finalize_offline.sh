#!/bin/bash
echo "🚀 Finalisation du mode hors ligne..."

# Mise à jour de useProduits.ts avec useOfflineMutation
cat > src/hooks/useProduits.ts << 'EOFPRODUITS'
...
echo "✅ useProduits.ts mis à jour avec useOfflineMutation"
echo "👉 Redémarrez l'application : npm start"
