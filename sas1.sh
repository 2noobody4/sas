...
# ============================================================
# Point 11 (confirmé) — RLS absentes sur les tables comptables
# + durcissement de `employes` (actuellement grand ouvert)
#
# Génère sql/rls_fixes_point11.sql — À RELIRE avant exécution
# dans Supabase SQL Editor (adapte les rôles si besoin).
#
...
echo "→ Génération de sql/rls_fixes_point11.sql"
cat > sql/rls_fixes_point11.sql << 'EOF'
-- ============================================================
...
echo ""
echo "============================================================"
echo "Terminé — sql/rls_fixes_point11.sql généré."
echo "Relis-le, ajuste les rôles si besoin, puis colle-le dans"
echo "Supabase SQL Editor pour l'exécuter."
echo ""
echo "⚠️ Vérifie d'abord avec sql/audit_rls_comptabilite.sql que"
echo "   rls_enabled est bien à 'false' sur les 6 tables comptables"
echo "   avant d'activer RLS — sinon tu risques de bloquer l'accès"
echo "   à des rôles qui en avaient besoin sans le savoir."
echo "============================================================"
